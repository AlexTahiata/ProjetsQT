...
void Widget::on_pushButtonSuite_clicked()
{
    ui->textEdit->clear();
    afficherInfos();
    ui->tabWidgetPoids->setCurrentIndex(1);
}
...
void Widget::afficherInfos()
{
    ...
    ui->textEdit->append("Bienvenue, "+nom +" "+prenom+"\n");
    ...
    ui->textEdit->append("Votre corpulence est qualifiée de "+ corpulences[indiceCorpulence]);
